...
pub struct GridTheme {
    ...
    pub pinned_header_background: Color32,
    pub row_odd: Color32,
    pub row_even: Color32,
    pub row_hover: Color32,
    pub pinned_row_background: Color32,
    pub cell_color: Color32,
    pub muted_color: Color32,
    pub surface: Color32,
    pub accent: Color32,
    pub pinned_indicator: Color32,
    ...
    /// CSS variable.
    pub cell_invalid_border: Color32,
    pub cell_invalid_background: Color32,
    /// Row tints for the row-edit lifecycle (mark_grid_row_dirty /
    /// mark_grid_row_saving / set_grid_row_save_error). Mirrors the TS
    /// `--ui-grid-row-edit-*` CSS variables.
    pub row_dirty_background: Color32,
    pub row_saving_background: Color32,
    pub row_error_background: Color32,
    pub radius: f32,
...
impl GridTheme {
    pub fn default_light() -> Self {
        Self {
            ...
            row_saving_background: rgba(37, 99, 235, 22),
            row_error_background: rgba(220, 38, 38, 28),
            radius: 4.0,
            header_weight: 700.0,
            cell_padding_y: 12.0,
            cell_padding_x: 16.0,
    ...
    pub fn default_dark() -> Self {
        Self {
            ...
            row_saving_background: rgba(103, 232, 249, 28),
            row_error_background: rgba(255, 107, 107, 50),
            radius: 4.0,
            header_weight: 700.0,
            cell_padding_y: 12.0,
            cell_padding_x: 16.0,
    ...
    pub fn wireframe_dark() -> Self {
        Self {
            ...
            row_dirty_background: rgba(245, 158, 11, 50),
            row_saving_background: rgba(93, 255, 154, 28),
            row_error_background: rgba(255, 107, 107, 50),
            radius: 0.0,
            header_weight: 700.0,
            cell_padding_y: 12.0,
    ...
    pub fn wireframe_light() -> Self {
        Self {
            ...
            row_saving_background: rgba(20, 128, 74, 22),
            row_error_background: rgba(185, 28, 28, 28),
            radius: 0.0,
            header_weight: 700.0,
            cell_padding_y: 12.0,
            cell_padding_x: 16.0,
